...
void MeanfieldIteration<Dtype>::Forward_cpu() {
  ...
  caffe_set(count_, Dtype(0.0), message_passing_.mutable_cpu_data());
...
void MeanfieldIteration<Dtype>::Backward_cpu() {
  ...
  caffe_set(this->blobs_[2]->count(), Dtype(0.0), this->blobs_[2]->mutable_cpu_diff());
  ...
  caffe_set(this->blobs_[0]->count(), Dtype(0.0), this->blobs_[0]->mutable_cpu_diff());
  caffe_set(this->blobs_[1]->count(), Dtype(0.0), this->blobs_[1]->mutable_cpu_diff());
